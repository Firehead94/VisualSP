...
class MainGui(QWidget):
    ...
    def setupUi(self):
        ...
        self.Source = QtWidgets.QComboBox(self.widget_2)
        self.Source.setMinimumSize(QtCore.QSize(200, 35))
        font = QtGui.QFont()
        font.setFamily("Tw Cen MT")
        font.setPointSize(20)
        self.Source.setFont(font)
        self.Source.setStyleSheet("color: WHITE;")
        ...
        font.setFamily("Tw Cen MT")
        font.setPointSize(20)
        self.featureDetections.setFont(font)
        self.featureDetections.setStyleSheet("color: WHITE;")
        self.featureDetections.setObjectName("featureDetections")
